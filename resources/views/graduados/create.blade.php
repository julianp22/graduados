...
<div class="container p-4">
    <div class="row">
        <div class="col-12 col-sm-10 col-lg-6 mx-auto">
            ...
            <form class="bg-white py-3 px-4 shadow rounded" method="POST" action="{{ route('graduados.store') }}"
                ...
                <h3 class="text-center">Registrar graduado</h1>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control border-0 bg-light shadow-sm @error('nombre') is-invalid @enderror"
                            ...
                            value="{{ old('nombre', $graduado->nombre) }}" onkeydown="return /[a-z, ]/i.test(event.key)"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control border-0 bg-light shadow-sm @error('cedula') is-invalid @enderror"
                            id="cedula" type="number" placeholder="Cedula" name="cedula"
                    ...
                    <div class="form-group">
                        ...
                        <input
                            class="form-control border-0 bg-light shadow-sm @error('fecha_grado') is-invalid @enderror"
                            id="fecha_grado" type="date" placeholder="Fecha de grado" name="fecha_grado"
                    ...
                    <div class="form-group">
                        ...
                        <input
                            class="form-control border-0 bg-light shadow-sm @error('num_celular') is-invalid @enderror"
                            id="num_celular" type="number" placeholder="Numero de célular" name="num_celular"
                    ...
                    <div class="form-group">
                        ...
                        <select
                            class="form-control border-0 bg-light shadow-sm @error('pais_residencia') is-invalid @enderror"
                            ...
                            <option value="Colombia" id="CO" @if (old('pais_residencia')=='Colombia' )
                                selected="selected" @endif>Colombia</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" id="foto" accept="image/*" name="foto"
                            value="{{ old('foto', $graduado->foto) }}" class="@error('foto') is-invalid @enderror">
                        @error('foto')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
